...
const greeting = {
  ...
  subTitle: emoji(
    "Un apasionado Full Stack Software Developer 🚀 tengo experiencia construyendo aplicaciones Web y Mobiles con JavaScript / Reactjs / Nodejs / React Native y algunas otras geniales bibliotecas y frameworks.",
  ),
  resumeLink:
...
"Diseño y construction de aplicaciones web(single page application).",
